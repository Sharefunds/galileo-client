...
**ResponseData** | [***interface{}**](interface{}.md) | A structure for the response data. This endpoint does not return response data, so it will always be empty. | [default to null]
