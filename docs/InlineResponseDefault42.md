...
**ResponseData** | [**[]CreateVirtualCardResponseResponseData**](CreateVirtualCardResponse_response_data.md) | A structure for the response data. It can be empty but usually will contain information. | [default to null]
