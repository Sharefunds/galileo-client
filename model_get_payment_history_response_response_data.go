...
type GetPaymentHistoryResponseResponseData struct {
	...
	// The start date for the response
	StartDate time.Time `json:"start_date"`
	// The end date for the response
	EndDate time.Time `json:"end_date"`
	// List of Payments
	Payments []ResponseData29Payments `json:"payments"`
}
