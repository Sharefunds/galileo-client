...
type GetIngoCustomerIdBody struct {
	...
	// Unique identifier for a cardholder's device using the Ingo SDK. For mobile apps. Pattern: 1&ndash;255 characters Example: `\"123456789009876\"`
