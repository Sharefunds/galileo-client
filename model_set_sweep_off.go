...
type SetSweepOff struct {
	...
	// The sweepOffEndDate specifies the last date that a daily sweep should be performed. Pattern: `YYYY-MM-DD` Example: `\"2016-01-01\"`
	SweepOffEndDate string `json:"sweepOffEndDate"`
}
