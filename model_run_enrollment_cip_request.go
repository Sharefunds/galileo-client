...
type RunEnrollmentCipRequest struct {
	...
	// Specifies the type of primary identifier in the `id` parameter.  This parameter is **required** when `id` is populated. See the **ID** column in the <a href=\"ref:api-reference-customer-id-types\" target=\"_blank\">Customer ID Types</a> table for valid values. Pattern: 1- or 2-digit integer Example: `\"123456789\"`
