...
type CreateCardImage struct {
	...
	LogoCoordinates string `json:"logoCoordinates,omitempty"`
	FontFileName string `json:"fontFileName,omitempty"`
	FontColor string `json:"fontColor,omitempty"`
	CardBlockSpaces int32 `json:"cardBlockSpaces,omitempty"`
	CardAttributes string `json:"cardAttributes,omitempty"`
	CvvAttributes string `json:"cvvAttributes,omitempty"`
	ExpiryAttributes string `json:"expiryAttributes,omitempty"`
