...
type AddCustomerNoteBody struct {
	...
	// Text of the note. Pattern: Alphanumeric string including punctuation Example: `\"Sample note message here.\"`
	Note string `json:"note"`
	// Pass `1` to make the note permanent in the <<glossary:CST>>. Pattern: `0` or `1` Example: `\"1\"`
