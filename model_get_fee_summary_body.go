...
type GetFeeSummaryBody struct {
	...
	// Start date for the year to date. Pattern: YYYY-MM-DD Example: `\"2022-01-01\"`
	YtdStart string `json:"ytdStart"`
	// End date of the year to date. Pattern: YYYY-MM-DD Example: `\"2022-11-05\"`
	YtdEnd string `json:"ytdEnd"`
	// Start date of the month to date. Pattern: YYYY-MM-DD Example: `\"2022-03-01\"`
	MtdStart string `json:"mtdStart"`
	// End date of the month to date. Pattern: YYYY-MM-DD Example: `\"2022-03-15\"`
	MtdEnd string `json:"mtdEnd"`
}
