...
type CreateFbEnrollmentBody struct {
	...
	// Unique location identifier; see location types. Pattern: Must be a number if type is 0; Must be less than 15 characters if type is 1. Example: `\"a455-3483\"`
	Location string `json:"location"`
	// 0=Galileo Location ID  1=Partner Location ID Pattern: `0` or `1` Example: `1`
	...
	// Specifies whether to send alerts regarding the enrollment process. Pattern: `0` or `1` Example: `1`
