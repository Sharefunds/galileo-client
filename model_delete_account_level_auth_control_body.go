...
type DeleteAccountLevelAuthControlBody struct {
	...
	// The control ID of the velocity control to delete, as returned by <a href=\"ref:post_getauthcontrol\" target=\"_blank\">Get Auth Control</a>. Pattern: Integer, max  18 digits Example: 10492
