...
type ExpireAuthorizationBody struct {
	...
	// The Galileo-generated authorization ID (`auth_id`) as returned by <a href=\"ref:post_getauthhistory\" target=\"_blank\">Get Authorization History</a>. Pattern: Positive integer Example: `58344373`
