...
type DeleteAccountLevelMccControlBody struct {
	...
	// The MCC control start range to delete Pattern: Integer, max  18 digits Example: 150
	MccControlStart int32 `json:"mccControlStart"`
	// The MCC control end range to delete Pattern: Integer, max  18 digits Example: 250
	MccControlEnd int32 `json:"mccControlEnd"`
}
