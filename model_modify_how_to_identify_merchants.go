...
type ModifyHowToIdentifyMerchants struct {
	...
	// 'merch_desc'=Merchant Description, 'merch_id'=Merchant ID Pattern: Value must be 'merch_desc' or 'merch_id'.  Example: `\"merch_id\"`
