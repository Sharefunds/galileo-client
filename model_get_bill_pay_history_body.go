...
type GetBillPayHistoryBody struct {
	...
	// The beginning date for the date range, either a date or a date-time. Pattern: YYYY-MM-DD or YYYY-MM-DD hh:mm:ss Example: `\"2016-01-01\"`
	StartDate string `json:"startDate"`
	// The end date for the date range, either a date or a date-time. Must be equal to or later than `startDate`. Max 1098 days (~3 years) after `startDate`.  Pattern: YYYY-MM-DD or YYYY-MM-DD hh:mm:ss Example: `\"2016-01-01\"`
	...
	// The maximum number of records to be returned in the method response. Pattern: Positive integer value in the range of 1 and 99999. Example: `100`
