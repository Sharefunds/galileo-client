...
type SetUserDefinedAccountFieldBody struct {
	...
	// Field identifier or key name. Pattern: 1&ndash;15 alphanumeric characters Example: `\"MYACCTID\"`
	FieldId string `json:"fieldId"`
	// Field value. Pattern: 1&ndash;175 characters Example: `\"48547537447-ABCD\"`
