...
type GetFundingTransactionHistory struct {
	...
	// The start date for the date range, either a date or a date-time. Pattern: YYYY-MM-DD or YYYY-MM-DD hh:mm:ss Example: `'2022-01-01'`
	StartDate string `json:"startDate,omitempty"`
	// The end date for the date range, either a date or a date-time. Must be equal to or later than `'startDate'`. Pattern: YYYY-MM-DD or YYYY-MM-DD hh:mm:ss Example: `'2022-12-31'`
