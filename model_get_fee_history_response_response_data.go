...
type GetFeeHistoryResponseResponseData struct {
	// A count of fees being recorded on
	FeeCount int32 `json:"fee_count"`
	...
	// The start date of the response
	StartDate time.Time `json:"start_date"`
	// The end date of the response
	EndDate time.Time `json:"end_date"`
	// List of fees
	Fees []ResponseData30Fees `json:"fees"`
}
