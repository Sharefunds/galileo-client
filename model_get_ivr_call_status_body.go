...
type GetIvrCallStatusBody struct {
	...
	// The call identifier (`call_id`) as returned by the <a href=\"ref:post_createivrcall\" target=\"_blank\">Create IVR Call</a> endpoint. Pattern: Integer Example: `48347823`
	CallId int32 `json:"callId"`
}
