...
type ModifyPaperBillerBody struct {
	...
	// Identifier for the biller (`biller_id`) as returned by the <a href=\"ref:post_addpaperbiller\" target=\"_blank\">Add Paper Biller</a> or <a href=\"ref:post_getbillers\" target=\"_blank\">Get Billers</a> endpoint. Pattern: Integer Example: `2982`
	...
	BillerCity string `json:"billerCity,omitempty"`
	...
	BillerZip string `json:"billerZip,omitempty"`
