...
type GetScheduledBillPaymentsBody struct {
	...
	// The maximum number of records per page to be returned. Pattern: Positive integer `1-99999` Example: `100`
	RecordCntScheduled int32 `json:"recordCntScheduled,omitempty"`
	// The number of the page to retrieve. Pattern: Integer value of `1` or greater Example: `3`
	PageScheduled int32 `json:"pageScheduled,omitempty"`
	// The maximum number of records per page to be returned. Pattern: Positive integer `1-99999` Example: `100`
	RecordCntFuture int32 `json:"recordCntFuture,omitempty"`
	// The number of the page to retrieve. Pattern: Integer value of `1` or greater Example: `3`
	PageFuture int32 `json:"pageFuture,omitempty"`
}
