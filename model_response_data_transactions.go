...
type ResponseDataTransactions struct {
	...
	// Identifier for the transaction activity type. See the <a href=\"ref:api-reference-activity-type\" target=\"_blank\">Activity Type</a> enumeration.
	ActType string `json:"act_type"`
	// Galileo system timestamp when the transaction posted to the customer account, in Mountain Standard Time (-0700)
	...
	// Description of the activity type specified in the `act_type` field. See the <a href=\"ref:api-reference-activity-type\" target=\"_blank\">Activity Type</a> enumeration.
	...
	AchTransactionId string `json:"ach_transaction_id,omitempty"`
	// Optional identifier for a transaction that you supply. External to the Galileo system.
	ExternalTransId string `json:"external_trans_id,omitempty"`
	...
	LocalAmt string `json:"local_amt,omitempty"`
	// Currency code for `local_amt` (DE049)
	LocalCurrCode string `json:"local_curr_code,omitempty"`
	// The transaction amount in the settlement currency (DE005)
	SettleAmt string `json:"settle_amt,omitempty"`
	// Currency code for `settle_amt` (DE050)
	SettleCurrCode string `json:"settle_curr_code,omitempty"`
	// The transaction amount in the currency of the account (DE006) 
	BillingAmt string `json:"billing_amt,omitempty"`
	// Currency code for `billing_amt` (DE051)
	BillingCurrCode string `json:"billing_curr_code,omitempty"`
	...
	FormattedMerchantDesc string `json:"formatted_merchant_desc,omitempty"`
	...
	// Indicates whether a PIN was input at the point of sale. `Y` = No PIN was input. `N` = A PIN was input. `None` = Not a card transaction.
	CreditInd string `json:"credit_ind,omitempty"`
