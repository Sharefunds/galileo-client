...
type SetAlertsBody struct {
	...
	// List of alerts to enable for the specified account. Pattern: JSON string Example: `\"{\"BADJ\":{\"email_flag\":\"1\",\"pager_flag\": \"1\"},\"BAUT\":{\"email_flag\":\"1\",\"pager_flag\":\"1\"}}\"`
