...
type CancelAchTransactionBody struct {
	...
	// ACH transaction identifier (`ach_transaction_id`) of the transaction to cancel, as returned by the <a href=\"ref:post_createachtransaction\" target=\"_blank\">Create ACH Transaction</a> endpoint. Pattern: Positive integer Example: `34890348`
	AchTransactionId int32 `json:"achTransactionId"`
}
